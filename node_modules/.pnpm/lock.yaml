...
importers:
  ...
  .:
    dependencies:
      ...
      react-i18next:
        specifier: ^16.5.0
        version: 16.5.4(i18next@25.8.13(typescript@5.9.3))(react-dom@19.2.4(react@19.2.4))(react@19.2.4)(typescript@5.9.3)
    ...
    devDependencies:
      ...
      '@vitest/coverage-v8':
        specifier: ^4.0.15
        version: 4.0.18(vitest@4.0.18(@types/node@25.3.3)(jiti@2.6.1)(jsdom@27.4.0)(lightningcss@1.31.1))
      ...
      vitest:
        specifier: ^4.0.15
        version: 4.0.18(@types/node@25.3.3)(jiti@2.6.1)(jsdom@27.4.0)(lightningcss@1.31.1)
...
packages:
  ...
  '@ast-grep/cli-darwin-arm64@0.40.5':
    resolution: {integrity: sha512-T9CzwJ1GqQhnANdsu6c7iT1akpvTVMK+AZrxnhIPv33Ze5hrXUUkqan+j4wUAukRJDqU7u94EhXLSLD+5tcJ8g==}
    engines: {node: '>= 10'}
    cpu: [arm64]
    os: [darwin]

  '@ast-grep/cli-darwin-x64@0.40.5':
    resolution: {integrity: sha512-ez9b2zKvXU8f4ghhjlqYvbx6tWCKJTuVlNVqDDfjqwwhGeiTYfnzMlSVat4ElYRMd21gLtXZIMy055v2f21Ztg==}
    engines: {node: '>= 10'}
    cpu: [x64]
    os: [darwin]

  '@ast-grep/cli-linux-arm64-gnu@0.40.5':
    resolution: {integrity: sha512-VXa2L1IEYD66AMb0GuG7VlMMbPmEGoJUySWDcwSZo/D9neiry3MJ41LQR5oTG2HyhIPBsf9umrXnmuRq66BviA==}
    engines: {node: '>= 10'}
    cpu: [arm64]
    os: [linux]

  '@ast-grep/cli-linux-x64-gnu@0.40.5':
    resolution: {integrity: sha512-GQC5162eIOWXR2eQQ6Knzg7/8Trp5E1ODJkaErf0IubdQrZBGqj5AAcQPcWgPbbnmktjIp0H4NraPpOJ9eJ22A==}
    engines: {node: '>= 10'}
    cpu: [x64]
    os: [linux]

  '@ast-grep/cli-win32-arm64-msvc@0.40.5':
    resolution: {integrity: sha512-YiZdnQZsSlXQTMsZJop/Ux9MmUGfuRvC2x/UbFgrt5OBSYxND+yoiMc0WcA3WG+wU+tt4ZkB5HUea3r/IkOLYA==}
    engines: {node: '>= 10'}
    cpu: [arm64]
    os: [win32]

  '@ast-grep/cli-win32-ia32-msvc@0.40.5':
    resolution: {integrity: sha512-MHkCxCITVTr8sY9CcVqNKbfUzMa3Hc6IilGXad0Clnw2vNmPfWqSky+hU/UTerr5YHWwWfAVURH7ANZgirtx0Q==}
    engines: {node: '>= 10'}
    cpu: [ia32]
    os: [win32]

  '@ast-grep/cli-win32-x64-msvc@0.40.5':
    resolution: {integrity: sha512-/MJ5un7yxlClaaxou9eYl+Kr2xr/yTtYtTq5aLBWjPWA6dmmJ1nAJgx5zKHVuplFXFBrFDQk3paEgAETMTGcrA==}
    engines: {node: '>= 10'}
    cpu: [x64]
    os: [win32]

  '@ast-grep/cli@0.40.5':
    resolution: {integrity: sha512-yVXL7Gz0WIHerQLf+MVaVSkhIhidtWReG5akNVr/JS9OVCVkSdz7gWm7H8jVv2M9OO1tauuG76K3UaRGBPu5lQ==}
    engines: {node: '>= 12.0.0'}
    hasBin: true
...
snapshots:
  ...
  '@vitest/coverage-v8@4.0.18(vitest@4.0.18(@types/node@25.3.3)(jiti@2.6.1)(jsdom@27.4.0)(lightningcss@1.31.1))':
    dependencies:
      '@bcoe/v8-coverage': 1.0.2
      '@vitest/utils': 4.0.18
      ast-v8-to-istanbul: 0.3.12
      ...
      std-env: 3.10.0
      tinyrainbow: 3.0.3
      vitest: 4.0.18(@types/node@25.3.3)(jiti@2.6.1)(jsdom@27.4.0)(lightningcss@1.31.1)
  ...
  react-i18next@16.5.4(i18next@25.8.13(typescript@5.9.3))(react-dom@19.2.4(react@19.2.4))(react@19.2.4)(typescript@5.9.3):
    dependencies:
      '@babel/runtime': 7.28.6
      html-parse-stringify: 3.0.1
      i18next: 25.8.13(typescript@5.9.3)
